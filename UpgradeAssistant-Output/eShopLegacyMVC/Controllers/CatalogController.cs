...
namespace eShopLegacyMVC.Controllers
{
    public class CatalogController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Index(int pageSize = 10, int pageIndex = 0)
        {
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Details(int? id)
        {
            ...
            if (id == null)
            {
                return new Microsoft.AspNetCore.Mvc.StatusCodeResult(HttpStatusCode.BadRequest);
            }
        ...
        public Microsoft.AspNetCore.Mvc.ActionResult Create([Bind(Include = "Id,Name,Description,Price,PictureFileName,CatalogTypeId,CatalogBrandId,AvailableStock,RestockThreshold,MaxStockThreshold,OnReorder")] CatalogItem catalogItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public Microsoft.AspNetCore.Mvc.ActionResult Edit([Bind(Include = "Id,Name,Description,Price,PictureFileName,CatalogTypeId,CatalogBrandId,AvailableStock,RestockThreshold,MaxStockThreshold,OnReorder")] CatalogItem catalogItem)
        {
        ...
        [ValidateAntiForgeryToken]
        public Microsoft.AspNetCore.Mvc.ActionResult DeleteConfirmed(int id)
        {
