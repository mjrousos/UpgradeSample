...
namespace eShopLegacyMVC.Models.Infrastructure
{
    public class CatalogDBInitializer : CreateDatabaseIfNotExists<CatalogDBContext>
    {
        ...
        public CatalogDBInitializer(CatalogItemHiLoGenerator indexGenerator, IConfiguration configuration, IHostEnvironment environment)
        {
        ...
        {
            string csvFileCatalogTypes = Path.Combine(environment.ContentRootPath, "Setup", "CatalogTypes.csv");
        ...
        {
            string csvFileCatalogBrands = Path.Combine(environment.ContentRootPath, "Setup", "CatalogBrands.csv");
        ...
        {
            string csvFileCatalogItems = Path.Combine(environment.ContentRootPath, "Setup", "CatalogItems.csv");
        ...
        private void AddCatalogItemPictures()
        {
            ...
            DirectoryInfo picturePath = new DirectoryInfo(Path.Combine(environment.ContentRootPath, "Pics"));
